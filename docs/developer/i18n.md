...
The above command will investigate resources within Frapid and all available modules and pack them into a combined file for each supported culture. If there are translations are partially or fully done, Frapid will still keep all translation work intact. The translation packages are placed under this directory:
