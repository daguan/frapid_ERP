...
namespace Frapid.Web
{
    public static class BundleConfig
    {
        ...
        {
            if(FrapidHttpContext.GetCurrent().IsDebuggingEnabled)
            {
        ...
        {
            bundles.Add(FrapidHttpContext.GetCurrent().IsDebuggingEnabled ? new Bundle(name).Include(files) : new ScriptBundle(name).Include(files));
        }
