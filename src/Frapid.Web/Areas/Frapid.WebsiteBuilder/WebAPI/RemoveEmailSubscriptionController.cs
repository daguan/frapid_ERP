...
namespace Frapid.WebsiteBuilder.Api
{
    ...
    public class RemoveEmailSubscriptionController : FrapidApiController
    {
        ...
        /// </summary>
        private readonly IRemoveEmailSubscriptionRepository repository;
        ...
        public RemoveEmailSubscriptionController(IRemoveEmailSubscriptionRepository repository, string catalog, LoginView view)
        {
