...
namespace Frapid.WebsiteBuilder.Api
{
    ...
    public class GetCategoryIdByCategoryNameController : FrapidApiController
    {
        ...
        /// </summary>
        private readonly IGetCategoryIdByCategoryNameRepository repository;
        ...
        public GetCategoryIdByCategoryNameController(IGetCategoryIdByCategoryNameRepository repository, string catalog, LoginView view)
        {
        ...
        public EntityView GetAnnotation()
        {
            ...
            return new EntityView
            {
                Columns = new List<EntityColumn>()
                                {
                                        new EntityColumn { ColumnName = "_category_name",  PropertyName = "CategoryName",  DataType = "string",  DbDataType = "text",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 }
                                }
            };
        }
