...
{
    public class YesterdaysEmailSubscriptionTests
    {
        public static YesterdaysEmailSubscriptionController Fixture()
        {
            YesterdaysEmailSubscriptionController controller = new YesterdaysEmailSubscriptionController(new YesterdaysEmailSubscriptionRepository());
            return controller;
        }
