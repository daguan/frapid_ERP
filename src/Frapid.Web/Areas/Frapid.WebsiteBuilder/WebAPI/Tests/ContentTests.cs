...
namespace Frapid.WebsiteBuilder.Api.Tests
{
    public class ContentTests
    {
        ...
        public void Get()
        {
            Frapid.WebsiteBuilder.Entities.Content content = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.WebsiteBuilder.Entities.Content content = Fixture().GetFirst();
            Assert.NotNull(content);
        }
        ...
        {
            Frapid.WebsiteBuilder.Entities.Content content = Fixture().GetPrevious(0);
            Assert.NotNull(content);
        }
        ...
        public void Next()
        {
            Frapid.WebsiteBuilder.Entities.Content content = Fixture().GetNext(0);
            Assert.NotNull(content);
        }
        ...
        public void Last()
        {
            Frapid.WebsiteBuilder.Entities.Content content = Fixture().GetLast();
            Assert.NotNull(content);
        }
        ...
        {
            IEnumerable<Frapid.WebsiteBuilder.Entities.Content> contents = Fixture().Get(new int[] { });
