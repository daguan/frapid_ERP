...
{
    public class EmailSubscriptionInsertViewTests
    {
        public static EmailSubscriptionInsertViewController Fixture()
        {
            EmailSubscriptionInsertViewController controller = new EmailSubscriptionInsertViewController(new EmailSubscriptionInsertViewRepository());
            return controller;
        }
