...
namespace Frapid.WebsiteBuilder.Api
{
    ...
    public class PublishedContentViewController : FrapidApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 published content views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 published content views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
