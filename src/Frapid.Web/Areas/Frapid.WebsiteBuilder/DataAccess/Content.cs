...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class Content : DbAccess, IContentRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "website.contents" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.Content> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.contents ORDER BY content_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.Content>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "website.contents" producing a paginated result of 50.
        /// </summary>
