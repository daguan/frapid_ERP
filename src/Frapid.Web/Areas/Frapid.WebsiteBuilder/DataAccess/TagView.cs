...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class TagView : DbAccess, ITagViewRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "website.tag_view" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.TagView> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.tag_view ORDER BY 1 LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.TagView>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on view "website.tag_view" producing a paginated result of 50.
        /// </summary>
