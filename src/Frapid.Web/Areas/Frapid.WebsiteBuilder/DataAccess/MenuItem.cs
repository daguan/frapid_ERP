...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class MenuItem : DbAccess, IMenuItemRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "website.menu_items" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.MenuItem> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.menu_items ORDER BY menu_item_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.MenuItem>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "website.menu_items" producing a paginated result of 50.
        /// </summary>
