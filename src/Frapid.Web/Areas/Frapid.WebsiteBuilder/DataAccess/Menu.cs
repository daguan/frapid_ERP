...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class Menu : DbAccess, IMenuRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "website.menus" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.menus ORDER BY menu_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.Menu>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "website.menus" producing a paginated result of 50.
        /// </summary>
