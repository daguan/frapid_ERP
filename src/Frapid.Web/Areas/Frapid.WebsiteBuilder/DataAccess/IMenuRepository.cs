...
namespace Frapid.WebsiteBuilder.DataAccess
{
    public interface IMenuRepository
    {
        ...
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetAll();
        ...
        Frapid.WebsiteBuilder.Entities.Menu Get(int menuId);

        /// <summary>
        /// Gets the first record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.WebsiteBuilder.Entities.Menu GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.WebsiteBuilder.Entities.Menu GetPrevious(int menuId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.WebsiteBuilder.Entities.Menu GetNext(int menuId);

        /// <summary>
        /// Gets the last record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.WebsiteBuilder.Entities.Menu GetLast();
        ...
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> Get(int[] menuIds);
        ...
        object AddOrEdit(dynamic menu, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 Menu classes.
        /// </summary>
        /// <returns>Returns the first page of collection of Menu class.</returns>
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetPaginatedResult();
        ...
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IMenuRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IMenuRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.WebsiteBuilder.Entities.Menu> GetFiltered(long pageNumber, string filterName);
