...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class Category : DbAccess, ICategoryRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "website.categories" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.Category> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.categories ORDER BY category_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.Category>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "website.categories" producing a paginated result of 50.
        /// </summary>
