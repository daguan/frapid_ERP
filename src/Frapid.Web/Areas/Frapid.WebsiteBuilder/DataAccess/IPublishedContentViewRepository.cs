...
namespace Frapid.WebsiteBuilder.DataAccess
{
    public interface IPublishedContentViewRepository
    {
        ...
        /// <summary>
        /// Produces a paginated result of 50 items from IPublishedContentViewRepository.
        /// </summary>
        ...
        /// <summary>
        /// Produces a paginated result of 50 items using the supplied filters from IPublishedContentViewRepository.
        /// </summary>
        ...
        /// <summary>
        /// Produces a paginated result of 50 items using the supplied filter name from IPublishedContentViewRepository.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of "PublishedContentView" class.</returns>
