...
namespace Frapid.WebsiteBuilder.DataAccess
{
    ...
    public class Contact : DbAccess, IContactRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "website.contacts" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.WebsiteBuilder.Entities.Contact> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM website.contacts ORDER BY contact_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.WebsiteBuilder.Entities.Contact>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "website.contacts" producing a paginated result of 50.
        /// </summary>
