...
SELECT * FROM config.create_menu('Frapid.WebsiteBuilder', 'Subscription Added', 'dashboard/website/templates/subscription/welcome', 'plus circle', 'Email Templates');
SELECT * FROM config.create_menu('Frapid.WebsiteBuilder', 'Subscription Removed', 'dashboard/website/templates/subscription/removed', 'minus circle', 'Email Templates');
