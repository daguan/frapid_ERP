...
namespace Frapid.Account.DataAccess
{
    ...
    public class GoogleAccessToken : DbAccess, IGoogleAccessTokenRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.google_access_tokens" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.GoogleAccessToken> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.google_access_tokens ORDER BY user_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.GoogleAccessToken>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.google_access_tokens" producing a paginated result of 50.
        /// </summary>
