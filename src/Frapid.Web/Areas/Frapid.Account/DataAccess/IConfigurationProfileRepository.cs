...
namespace Frapid.Account.DataAccess
{
    public interface IConfigurationProfileRepository
    {
        ...
        /// <summary>
        /// Produces a paginated result of 10 ConfigurationProfile classes.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered pagination against IConfigurationProfileRepository producing result of 10 items.
        /// </summary>
        ...
        /// <summary>
        /// Gets a filtered result of IConfigurationProfileRepository producing a paginated result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of ConfigurationProfile class.</returns>
