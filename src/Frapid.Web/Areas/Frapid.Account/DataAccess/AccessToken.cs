...
namespace Frapid.Account.DataAccess
{
    ...
    public class AccessToken : DbAccess, IAccessTokenRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.access_tokens" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.AccessToken> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.access_tokens ORDER BY access_token_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.AccessToken>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.access_tokens" producing a paginated result of 50.
        /// </summary>
