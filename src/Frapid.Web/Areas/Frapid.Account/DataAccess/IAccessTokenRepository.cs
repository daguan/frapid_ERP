...
namespace Frapid.Account.DataAccess
{
    public interface IAccessTokenRepository
    {
        ...
        /// <summary>
        /// Produces a paginated result of 50 AccessToken classes.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered pagination against IAccessTokenRepository producing result of 50 items.
        /// </summary>
        ...
        /// <summary>
        /// Gets a filtered result of IAccessTokenRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of AccessToken class.</returns>
