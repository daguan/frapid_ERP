...
namespace Frapid.Account.DataAccess
{
    ...
    public class User : DbAccess, IUserRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.users" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.User> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.users ORDER BY user_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.User>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.users" producing a paginated result of 50.
        /// </summary>
