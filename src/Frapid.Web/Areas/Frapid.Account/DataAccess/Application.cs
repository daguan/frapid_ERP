...
namespace Frapid.Account.DataAccess
{
    ...
    public class Application : DbAccess, IApplicationRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.applications" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.Application> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.applications ORDER BY application_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.Application>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.applications" producing a paginated result of 50.
        /// </summary>
