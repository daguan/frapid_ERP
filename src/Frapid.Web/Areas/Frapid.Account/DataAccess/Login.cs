...
namespace Frapid.Account.DataAccess
{
    ...
    public class Login : DbAccess, ILoginRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.logins" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.Login> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.logins ORDER BY login_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.Login>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.logins" producing a paginated result of 50.
        /// </summary>
