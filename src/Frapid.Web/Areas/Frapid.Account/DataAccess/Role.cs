...
namespace Frapid.Account.DataAccess
{
    ...
    public class Role : DbAccess, IRoleRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.roles" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.Role> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.roles ORDER BY role_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.Role>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.roles" producing a paginated result of 50.
        /// </summary>
