...
namespace Frapid.Account.DataAccess
{
    ...
    public class ConfigurationProfile : DbAccess, IConfigurationProfileRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.configuration_profiles" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.ConfigurationProfile> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.configuration_profiles ORDER BY profile_id LIMIT 10 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.ConfigurationProfile>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.configuration_profiles" producing a paginated result of 10.
        /// </summary>
