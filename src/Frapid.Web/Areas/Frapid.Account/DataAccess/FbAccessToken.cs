...
namespace Frapid.Account.DataAccess
{
    ...
    public class FbAccessToken : DbAccess, IFbAccessTokenRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "account.fb_access_tokens" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<Frapid.Account.Entities.FbAccessToken> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM account.fb_access_tokens ORDER BY user_id LIMIT 10 OFFSET 0;";
            return Factory.Get<Frapid.Account.Entities.FbAccessToken>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "account.fb_access_tokens" producing a paginated result of 10.
        /// </summary>
