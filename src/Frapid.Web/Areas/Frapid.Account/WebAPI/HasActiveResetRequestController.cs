...
namespace Frapid.Account.Api
{
    ...
    public class HasActiveResetRequestController : FrapidApiController
    {
        ...
        /// </summary>
        private readonly IHasActiveResetRequestRepository repository;
        ...
        public HasActiveResetRequestController(IHasActiveResetRequestRepository repository, string catalog, LoginView view)
        {
