...
namespace Frapid.Account.Api
{
    ...
    public class GetUserIdByEmailController : FrapidApiController
    {
        ...
        /// </summary>
        private readonly IGetUserIdByEmailRepository repository;
        ...
        public GetUserIdByEmailController(IGetUserIdByEmailRepository repository, string catalog, LoginView view)
        {
