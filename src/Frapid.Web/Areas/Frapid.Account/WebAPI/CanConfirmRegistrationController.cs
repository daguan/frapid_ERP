...
namespace Frapid.Account.Api
{
    ...
    public class CanConfirmRegistrationController : FrapidApiController
    {
        ...
        /// </summary>
        private readonly ICanConfirmRegistrationRepository repository;
        ...
        public CanConfirmRegistrationController(ICanConfirmRegistrationRepository repository, string catalog, LoginView view)
        {
        ...
        public EntityView GetAnnotation()
        {
            ...
            return new EntityView
            {
                Columns = new List<EntityColumn>()
                                {
                                        new EntityColumn { ColumnName = "_token",  PropertyName = "Token",  DataType = "System.Guid",  DbDataType = "uuid",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 }
                                }
            };
        }
