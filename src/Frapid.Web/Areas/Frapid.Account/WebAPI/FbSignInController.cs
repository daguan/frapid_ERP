...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function FbSignIn.
    /// </summary>
    [RoutePrefix("api/v1.0/account/procedures/fb-sign-in")]
    public class FbSignInController : FrapidApiController
    {
        ...
        /// </summary>
        /// <returns>Returns the "fb sign in" annotation meta information to perform CRUD operation.</returns>
        ...
        /// <summary>
        ///     Creates meta information of "fb sign in" entity.
        /// </summary>
        /// <returns>Returns the "fb sign in" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
        ...
        public IEnumerable<DbFbSignInResult> Execute([FromBody] Annotation annotation)
        {
            try
            {
                this.repository.FbUserId = annotation.FbUserId;
