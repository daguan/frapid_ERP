...
namespace Frapid.Account.Api.Tests
{
    public class ConfigurationProfileTests
    {
        ...
        public void Get()
        {
            Frapid.Account.Entities.ConfigurationProfile configurationProfile = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Account.Entities.ConfigurationProfile configurationProfile = Fixture().GetFirst();
            Assert.NotNull(configurationProfile);
        }
        ...
        public void Next()
        {
            Frapid.Account.Entities.ConfigurationProfile configurationProfile = Fixture().GetNext(0);
            Assert.NotNull(configurationProfile);
        }
        ...
        {
            IEnumerable<Frapid.Account.Entities.ConfigurationProfile> configurationProfiles = Fixture().Get(new int[] { });
            Assert.NotNull(configurationProfiles);
        }
