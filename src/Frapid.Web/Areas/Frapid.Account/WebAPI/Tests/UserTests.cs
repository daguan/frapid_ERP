...
namespace Frapid.Account.Api.Tests
{
    public class UserTests
    {
        ...
        public void Get()
        {
            Frapid.Account.Entities.User user = Fixture().Get(0);
            Assert.NotNull(user);
        }
        ...
        public void First()
        {
            Frapid.Account.Entities.User user = Fixture().GetFirst();
            Assert.NotNull(user);
        }
        ...
        {
            Frapid.Account.Entities.User user = Fixture().GetPrevious(0);
            Assert.NotNull(user);
        }
        ...
        public void Next()
        {
            Frapid.Account.Entities.User user = Fixture().GetNext(0);
            Assert.NotNull(user);
        }
        ...
        public void Last()
        {
            Frapid.Account.Entities.User user = Fixture().GetLast();
            Assert.NotNull(user);
        }
        ...
        {
            IEnumerable<Frapid.Account.Entities.User> users = Fixture().Get(new int[] { });
