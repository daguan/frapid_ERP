...
{
    public class InstalledDomainTests
    {
        public static InstalledDomainController Fixture()
        {
            InstalledDomainController controller = new InstalledDomainController(new InstalledDomainRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Account.Entities.InstalledDomain installedDomain = Fixture().Get(0);
            Assert.NotNull(installedDomain);
        }
        ...
        public void First()
        {
            Frapid.Account.Entities.InstalledDomain installedDomain = Fixture().GetFirst();
            Assert.NotNull(installedDomain);
        }
        ...
        {
            Frapid.Account.Entities.InstalledDomain installedDomain = Fixture().GetPrevious(0);
            Assert.NotNull(installedDomain);
        }
        ...
        public void Next()
        {
            Frapid.Account.Entities.InstalledDomain installedDomain = Fixture().GetNext(0);
            Assert.NotNull(installedDomain);
        }
        ...
        public void Last()
        {
            Frapid.Account.Entities.InstalledDomain installedDomain = Fixture().GetLast();
            Assert.NotNull(installedDomain);
        }
        ...
        {
            IEnumerable<Frapid.Account.Entities.InstalledDomain> installedDomains = Fixture().Get(new int[] { });
            Assert.NotNull(installedDomains);
        }
