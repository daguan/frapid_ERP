...
namespace Frapid.Account.Api.Tests
{
    public class LoginTests
    {
        ...
        public void Get()
        {
            Frapid.Account.Entities.Login login = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Account.Entities.Login login = Fixture().GetFirst();
            Assert.NotNull(login);
        }
        ...
        {
            Frapid.Account.Entities.Login login = Fixture().GetPrevious(0);
            Assert.NotNull(login);
        }
        ...
        public void Next()
        {
            Frapid.Account.Entities.Login login = Fixture().GetNext(0);
            Assert.NotNull(login);
        }
        ...
        public void Last()
        {
            Frapid.Account.Entities.Login login = Fixture().GetLast();
            Assert.NotNull(login);
        }
        ...
        {
            IEnumerable<Frapid.Account.Entities.Login> logins = Fixture().Get(new long[] { });
