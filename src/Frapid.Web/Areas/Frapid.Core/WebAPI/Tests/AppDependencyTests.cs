...
namespace Frapid.Core.Api.Tests
{
    public class AppDependencyTests
    {
        ...
        {
            AppDependencyController controller = new AppDependencyController(new AppDependencyRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Core.Entities.AppDependency appDependency = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Core.Entities.AppDependency appDependency = Fixture().GetFirst();
            Assert.NotNull(appDependency);
        }
        ...
        {
            Frapid.Core.Entities.AppDependency appDependency = Fixture().GetPrevious(0);
            Assert.NotNull(appDependency);
        }
        ...
        public void Next()
        {
            Frapid.Core.Entities.AppDependency appDependency = Fixture().GetNext(0);
            Assert.NotNull(appDependency);
        }
        ...
        public void Last()
        {
            Frapid.Core.Entities.AppDependency appDependency = Fixture().GetLast();
            Assert.NotNull(appDependency);
        }
        ...
        {
            IEnumerable<Frapid.Core.Entities.AppDependency> appDependencies = Fixture().Get(new int[] { });
