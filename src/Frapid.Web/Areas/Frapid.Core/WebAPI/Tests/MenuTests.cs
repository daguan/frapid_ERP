...
namespace Frapid.Core.Api.Tests
{
    ...
    {
        public static CoreMenuController Fixture()
        {
            CoreMenuController controller = new CoreMenuController(new MenuRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Core.Entities.Menu menu = Fixture().Get(0);
            Assert.NotNull(menu);
        }
        ...
        public void First()
        {
            Frapid.Core.Entities.Menu menu = Fixture().GetFirst();
            Assert.NotNull(menu);
        }
        ...
        {
            Frapid.Core.Entities.Menu menu = Fixture().GetPrevious(0);
            Assert.NotNull(menu);
        }
        ...
        public void Next()
        {
            Frapid.Core.Entities.Menu menu = Fixture().GetNext(0);
            Assert.NotNull(menu);
        }
        ...
        public void Last()
        {
            Frapid.Core.Entities.Menu menu = Fixture().GetLast();
            Assert.NotNull(menu);
        }
        ...
        {
            IEnumerable<Frapid.Core.Entities.Menu> menus = Fixture().Get(new int[] { });
