...
namespace Frapid.Core.Api.Tests
{
    public class MenuLocaleTests
    {
        ...
        {
            MenuLocaleController controller = new MenuLocaleController(new MenuLocaleRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Core.Entities.MenuLocale menuLocale = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Core.Entities.MenuLocale menuLocale = Fixture().GetFirst();
            Assert.NotNull(menuLocale);
        }
        ...
        {
            Frapid.Core.Entities.MenuLocale menuLocale = Fixture().GetPrevious(0);
            Assert.NotNull(menuLocale);
        }
        ...
        public void Next()
        {
            Frapid.Core.Entities.MenuLocale menuLocale = Fixture().GetNext(0);
            Assert.NotNull(menuLocale);
        }
        ...
        public void Last()
        {
            Frapid.Core.Entities.MenuLocale menuLocale = Fixture().GetLast();
            Assert.NotNull(menuLocale);
        }
        ...
        {
            IEnumerable<Frapid.Core.Entities.MenuLocale> menuLocales = Fixture().Get(new int[] { });
