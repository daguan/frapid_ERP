...
namespace Frapid.Core.Api.Tests
{
    public class AppTests
    {
        ...
        public void Get()
        {
            Frapid.Core.Entities.App app = Fixture().Get(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void First()
        {
            Frapid.Core.Entities.App app = Fixture().GetFirst();
            Assert.NotNull(app);
        }
        ...
        {
            Frapid.Core.Entities.App app = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void Next()
        {
            Frapid.Core.Entities.App app = Fixture().GetNext(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void Last()
        {
            Frapid.Core.Entities.App app = Fixture().GetLast();
            Assert.NotNull(app);
        }
        ...
        {
            IEnumerable<Frapid.Core.Entities.App> apps = Fixture().Get(new string[] { });
            Assert.NotNull(apps);
        }
