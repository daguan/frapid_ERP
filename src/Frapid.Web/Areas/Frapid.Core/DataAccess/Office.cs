...
namespace Frapid.Core.DataAccess
{
    ...
    public class Office : DbAccess, IOfficeRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "core.offices" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.Office> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.offices ORDER BY office_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Core.Entities.Office>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.offices" producing a paginated result of 50.
        /// </summary>
