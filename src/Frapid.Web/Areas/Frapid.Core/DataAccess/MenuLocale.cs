...
namespace Frapid.Core.DataAccess
{
    ...
    public class MenuLocale : DbAccess, IMenuLocaleRepository
    {
        ...
        public IEnumerable<Frapid.Core.Entities.MenuLocale> GetAll()
        {
            ...
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql);
        }
        ...
        public Frapid.Core.Entities.MenuLocale Get(int menuLocaleId)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql, menuLocaleId).FirstOrDefault();
        }
        ...
        public Frapid.Core.Entities.MenuLocale GetFirst()
        {
            ...
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        public IEnumerable<Frapid.Core.Entities.MenuLocale> Get(int[] menuLocaleIds)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql, menuLocaleIds);
        }
        ...
        public IEnumerable<Frapid.DataAccess.Models.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM config.custom_field_definition_view WHERE table_name='core.menu_locale' ORDER BY field_order;";
                return Factory.Get<Frapid.DataAccess.Models.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from config.get_custom_field_definition('core.menu_locale'::text, @0::text) ORDER BY field_order;";
        ...
        public object AddOrEdit(dynamic menuLocale, List<Frapid.DataAccess.Models.CustomField> customFields)
        {
            ...
            {
                this.Update(menuLocale, Cast.To<int>(primaryKeyValue));
            }
            else
            {
            ...
            string sql = "DELETE FROM config.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=config.get_custom_field_form_name('core.menu_locale')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO config.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT config.get_custom_field_setup_id_by_table_name('core.menu_locale', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Performs a select statement on table "core.menu_locale" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.MenuLocale> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.menu_locale ORDER BY menu_locale_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql);
        }
        ...
        public IEnumerable<Frapid.Core.Entities.MenuLocale> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.MenuLocale>(this._Catalog, sql, offset);
        }

        public List<Frapid.DataAccess.Models.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM config.filters WHERE object_name='core.menu_locale' AND lower(filter_name)=lower(@0);";
        ...
        public long CountWhere(List<Frapid.DataAccess.Models.Filter> filters)
        {
            ...
            Frapid.DataAccess.FilterManager.AddFilters(ref sql, new Frapid.Core.Entities.MenuLocale(), filters);

            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Performs a filtered select statement on table "core.menu_locale" producing a paginated result of 50.
        /// </summary>
