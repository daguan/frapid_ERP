...
namespace Frapid.Core.DataAccess
{
    public interface IAppDependencyRepository
    {
        ...
        IEnumerable<Frapid.Core.Entities.AppDependency> GetAll();
        ...
        Frapid.Core.Entities.AppDependency Get(int appDependencyId);

        /// <summary>
        /// Gets the first record of AppDependency.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of AppDependency.</returns>
        Frapid.Core.Entities.AppDependency GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of AppDependency.</returns>
        Frapid.Core.Entities.AppDependency GetPrevious(int appDependencyId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of AppDependency.</returns>
        Frapid.Core.Entities.AppDependency GetNext(int appDependencyId);

        /// <summary>
        /// Gets the last record of AppDependency.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of AppDependency.</returns>
        Frapid.Core.Entities.AppDependency GetLast();
        ...
        IEnumerable<Frapid.Core.Entities.AppDependency> Get(int[] appDependencyIds);
        ...
        IEnumerable<Frapid.Core.Entities.AppDependency> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of AppDependency class.</returns>
        IEnumerable<Frapid.Core.Entities.AppDependency> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of AppDependency class.</returns>
        IEnumerable<Frapid.Core.Entities.AppDependency> GetFiltered(long pageNumber, string filterName);
