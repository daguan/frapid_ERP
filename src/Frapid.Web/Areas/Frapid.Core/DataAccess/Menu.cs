...
namespace Frapid.Core.DataAccess
{
    ...
    public class Menu : DbAccess, IMenuRepository
    {
        ...
        public IEnumerable<Frapid.Core.Entities.Menu> GetAll()
        {
            ...
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql);
        }
        ...
        public Frapid.Core.Entities.Menu Get(int menuId)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql, menuId).FirstOrDefault();
        }
        ...
        public Frapid.Core.Entities.Menu GetFirst()
        {
            ...
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.Core.Entities.Menu> Get(int[] menuIds)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql, menuIds);
        }
        ...
        public IEnumerable<Frapid.DataAccess.Models.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM config.custom_field_definition_view WHERE table_name='core.menus' ORDER BY field_order;";
                return Factory.Get<Frapid.DataAccess.Models.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from config.get_custom_field_definition('core.menus'::text, @0::text) ORDER BY field_order;";
        ...
        public IEnumerable<Frapid.DataAccess.Models.DisplayField> GetDisplayFields()
        {
            ...
            const string sql = "SELECT menu_id AS key, menu_name as value FROM core.menus;";
        ...
        public object AddOrEdit(dynamic menu, List<Frapid.DataAccess.Models.CustomField> customFields)
        {
            ...
            string sql = "DELETE FROM config.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=config.get_custom_field_form_name('core.menus')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO config.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT config.get_custom_field_setup_id_by_table_name('core.menus', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Performs a select statement on table "core.menus" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.Menu> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.menus ORDER BY menu_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql);
        }
        ...
        public IEnumerable<Frapid.Core.Entities.Menu> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.Menu>(this._Catalog, sql, offset);
        }

        public List<Frapid.DataAccess.Models.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM config.filters WHERE object_name='core.menus' AND lower(filter_name)=lower(@0);";
        ...
        public long CountWhere(List<Frapid.DataAccess.Models.Filter> filters)
        {
            ...
            Frapid.DataAccess.FilterManager.AddFilters(ref sql, new Frapid.Core.Entities.Menu(), filters);

            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Performs a filtered select statement on table "core.menus" producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "Menu" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.Core.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
