...
namespace Frapid.Core.DataAccess
{
    public interface IOfficeRepository
    {
        ...
        IEnumerable<Frapid.Core.Entities.Office> GetAll();
        ...
        Frapid.Core.Entities.Office Get(int officeId);

        /// <summary>
        /// Gets the first record of Office.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Core.Entities.Office GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Core.Entities.Office GetPrevious(int officeId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Core.Entities.Office GetNext(int officeId);

        /// <summary>
        /// Gets the last record of Office.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Core.Entities.Office GetLast();
        ...
        IEnumerable<Frapid.Core.Entities.Office> Get(int[] officeIds);
        ...
        object AddOrEdit(dynamic office, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 Office classes.
        /// </summary>
        /// <returns>Returns the first page of collection of Office class.</returns>
        IEnumerable<Frapid.Core.Entities.Office> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Core.Entities.Office> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IOfficeRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Office class.</returns>
        IEnumerable<Frapid.Core.Entities.Office> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IOfficeRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Office class.</returns>
        IEnumerable<Frapid.Core.Entities.Office> GetFiltered(long pageNumber, string filterName);
