...
{
    /// <summary>
    /// Prepares, validates, and executes the function "core.create_menu(_sort integer, _app_name text, _menu_name text, _url text, _icon text, _parent_menu_name text)" on the database.
    /// </summary>
    public class CreateMenuProcedure : DbAccess, ICreateMenuRepository
    {
        ...
        /// <summary>
        /// Maps to "_sort" argument of the function "core.create_menu".
        /// </summary>
        public int Sort { get; set; }
        /// <summary>
        /// Maps to "_app_name" argument of the function "core.create_menu".
        /// </summary>
        public string AppName { get; set; }
        /// <summary>
        /// Maps to "_menu_name" argument of the function "core.create_menu".
        /// </summary>
        ...
        /// <summary>
        /// Maps to "_icon" argument of the function "core.create_menu".
        /// </summary>
        public string Icon { get; set; }
        /// <summary>
        /// Maps to "_parent_menu_name" argument of the function "core.create_menu".
        /// </summary>
        ...
        /// Prepares, validates, and executes the function "core.create_menu(_sort integer, _app_name text, _menu_name text, _url text, _icon text, _parent_menu_name text)" on the database.
        /// </summary>
        /// <param name="sort">Enter argument value for "_sort" parameter of the function "core.create_menu".</param>
        /// <param name="appName">Enter argument value for "_app_name" parameter of the function "core.create_menu".</param>
        /// <param name="menuName">Enter argument value for "_menu_name" parameter of the function "core.create_menu".</param>
        /// <param name="url">Enter argument value for "_url" parameter of the function "core.create_menu".</param>
        /// <param name="icon">Enter argument value for "_icon" parameter of the function "core.create_menu".</param>
        /// <param name="parentMenuName">Enter argument value for "_parent_menu_name" parameter of the function "core.create_menu".</param>
        ...
        public int Execute()
        {
            ...
            string query = "SELECT * FROM core.create_menu(@Sort, @AppName, @MenuName, @Url, @Icon, @ParentMenuName);";
