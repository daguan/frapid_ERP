...
namespace Frapid.Core.DataAccess
{
    public interface IAppRepository
    {
        ...
        IEnumerable<Frapid.Core.Entities.App> GetAll();
        ...
        Frapid.Core.Entities.App Get(string appName);

        /// <summary>
        /// Gets the first record of App.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of App.</returns>
        Frapid.Core.Entities.App GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of App.</returns>
        Frapid.Core.Entities.App GetPrevious(string appName);
        ...
        /// <returns>Returns a non-live, non-mapped instance of App.</returns>
        Frapid.Core.Entities.App GetNext(string appName);

        /// <summary>
        /// Gets the last record of App.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of App.</returns>
        Frapid.Core.Entities.App GetLast();
        ...
        IEnumerable<Frapid.Core.Entities.App> Get(string[] appNames);
        ...
        /// <summary>
        /// Produces a paginated result of 50 App classes.
        /// </summary>
        /// <returns>Returns the first page of collection of App class.</returns>
        IEnumerable<Frapid.Core.Entities.App> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Core.Entities.App> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IAppRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of App class.</returns>
        IEnumerable<Frapid.Core.Entities.App> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IAppRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of App class.</returns>
        IEnumerable<Frapid.Core.Entities.App> GetFiltered(long pageNumber, string filterName);
