...
namespace Frapid.Core.DataAccess
{
    public interface IMenuRepository
    {
        ...
        IEnumerable<Frapid.Core.Entities.Menu> GetAll();
        ...
        Frapid.Core.Entities.Menu Get(int menuId);

        /// <summary>
        /// Gets the first record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Core.Entities.Menu GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Core.Entities.Menu GetPrevious(int menuId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Core.Entities.Menu GetNext(int menuId);

        /// <summary>
        /// Gets the last record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Core.Entities.Menu GetLast();
        ...
        IEnumerable<Frapid.Core.Entities.Menu> Get(int[] menuIds);
        ...
        IEnumerable<Frapid.Core.Entities.Menu> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Core.Entities.Menu> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.Core.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.Core.Entities.Menu> GetFiltered(long pageNumber, string filterName);
