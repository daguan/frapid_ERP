...
namespace Frapid.Core.DataAccess
{
    ...
    public class App : DbAccess, IAppRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "core.apps" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.App> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.apps ORDER BY app_name LIMIT 10 OFFSET 0;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.apps" producing a paginated result of 10.
        /// </summary>
