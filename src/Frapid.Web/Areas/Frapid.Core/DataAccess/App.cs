...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "core.apps".
    /// </summary>
    public class App : DbAccess, IAppRepository
    {
        ...
        /// <summary>
        /// Performs SQL count on the table "core.apps".
        /// </summary>
        /// <returns>Returns the number of rows of the table "core.apps".</returns>
        ...
        public long Count()
        {
            ...
            const string sql = "SELECT COUNT(*) FROM core.apps;";
            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "core.apps" to return all instances of the "App" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.App> GetAll()
        {
            ...
            const string sql = "SELECT * FROM core.apps ORDER BY app_name;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "core.apps" to return all instances of the "App" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "App" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        /// <summary>
        /// Executes a select query on the table "core.apps" with a where filter on the column "app_name" to return a single instance of the "App" class. 
        /// </summary>
        ...
        public Frapid.Core.Entities.App Get(string appName)
        {
            ...
            const string sql = "SELECT * FROM core.apps WHERE app_name=@0;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql, appName).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "core.apps". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "App" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Core.Entities.App GetFirst()
        {
            ...
            const string sql = "SELECT * FROM core.apps ORDER BY app_name LIMIT 1;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "core.apps" sorted by appName.
        /// </summary>
        ...
        public Frapid.Core.Entities.App GetPrevious(string appName)
        {
            ...
            const string sql = "SELECT * FROM core.apps WHERE app_name < @0 ORDER BY app_name DESC LIMIT 1;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql, appName).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "core.apps" sorted by appName.
        /// </summary>
        /// <param name="appName">The column "app_name" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "App" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Core.Entities.App GetNext(string appName)
        {
            ...
            const string sql = "SELECT * FROM core.apps WHERE app_name > @0 ORDER BY app_name LIMIT 1;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql, appName).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "core.apps". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "App" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Core.Entities.App GetLast()
        {
            ...
            const string sql = "SELECT * FROM core.apps ORDER BY app_name DESC LIMIT 1;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Executes a select query on the table "core.apps" with a where filter on the column "app_name" to return a multiple instances of the "App" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.App> Get(string[] appNames)
        {
            ...
            const string sql = "SELECT * FROM core.apps WHERE app_name IN (@0);";

            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql, appNames);
        }

        /// <summary>
        /// Custom fields are user defined form elements for core.apps.
        /// </summary>
        /// <returns>Returns an enumerable custom field collection for the table core.apps</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.DataAccess.Models.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM config.custom_field_definition_view WHERE table_name='core.apps' ORDER BY field_order;";
                return Factory.Get<Frapid.DataAccess.Models.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from config.get_custom_field_definition('core.apps'::text, @0::text) ORDER BY field_order;";
            return Factory.Get<Frapid.DataAccess.Models.CustomField>(this._Catalog, sql, resourceId);
        }

        /// <summary>
        /// Displayfields provide a minimal name/value context for data binding the row collection of core.apps.
        /// </summary>
        /// <returns>Returns an enumerable name and value collection for the table core.apps</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.DataAccess.Models.DisplayField> GetDisplayFields()
        {
            ...
            const string sql = "SELECT app_name AS key, version_number || ' (' || app_name || ')' as value FROM core.apps;";
        ...
        /// <summary>
        /// Inserts or updates the instance of App class on the database table "core.apps".
        /// </summary>
        ...
        public object AddOrEdit(dynamic app, List<Frapid.DataAccess.Models.CustomField> customFields)
        {
            ...
            string sql = "DELETE FROM config.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=config.get_custom_field_form_name('core.apps')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO config.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT config.get_custom_field_setup_id_by_table_name('core.apps', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Inserts the instance of App class on the database table "core.apps".
        /// </summary>
        ...
        public object Add(dynamic app)
        {
            ...
            return Factory.Insert(this._Catalog, app, "core.apps", "app_name");
        }

        /// <summary>
        /// Inserts or updates multiple instances of App class on the database table "core.apps";
        /// </summary>
                    ...
                    using (ITransaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic app in apps)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(app.app_name))
                            {
                                ...
                                db.Update("core.apps", "app_name", app, app.app_name);
                            }
                            else
                            {
                                result.Add(db.Insert("core.apps", "app_name", app));
                            }
                        }
        ...
        /// <summary>
        /// Updates the row of the table "core.apps" with an instance of "App" class against the primary key value.
        /// </summary>
        ...
        public void Update(dynamic app, string appName)
        {
            ...
            Factory.Update(this._Catalog, app, appName, "core.apps", "app_name");
        }

        /// <summary>
        /// Deletes the row of the table "core.apps" against the primary key value.
        /// </summary>
        ...
        public void Delete(string appName)
        {
            ...
            const string sql = "DELETE FROM core.apps WHERE app_name=@0;";
            Factory.NonQuery(this._Catalog, sql, appName);
        }

        /// <summary>
        /// Performs a select statement on table "core.apps" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.App> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.apps ORDER BY app_name LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql);
        }
        ...
        public IEnumerable<Frapid.Core.Entities.App> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<Frapid.Core.Entities.App>(this._Catalog, sql, offset);
        }

        public List<Frapid.DataAccess.Models.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM config.filters WHERE object_name='core.apps' AND lower(filter_name)=lower(@0);";
            return Factory.Get<Frapid.DataAccess.Models.Filter>(catalog, sql, filterName).ToList();
        }

        /// <summary>
        /// Performs a filtered count on table "core.apps".
        /// </summary>
        ...
        public long CountWhere(List<Frapid.DataAccess.Models.Filter> filters)
        {
            ...
            Sql sql = Sql.Builder.Append("SELECT COUNT(*) FROM core.apps WHERE 1 = 1");
            Frapid.DataAccess.FilterManager.AddFilters(ref sql, new Frapid.Core.Entities.App(), filters);

            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Performs a filtered select statement on table "core.apps" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Core.Entities.App> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters)
        {
            ...
            long offset = (pageNumber - 1) * 50;
            Sql sql = Sql.Builder.Append("SELECT * FROM core.apps WHERE 1 = 1");
