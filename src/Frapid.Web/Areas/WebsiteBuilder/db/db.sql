...
CREATE TABLE wb.modules
(
    module_id                                   SERIAL NOT NULL PRIMARY KEY,
    module_name                                 national character varying(100) NOT NULL,
    alias                                       national character varying(50) NOT NULL,    
...
CREATE TABLE wb.menu_groups
(
    menu_group_id                               SERIAL NOT NULL PRIMARY KEY,
    menu_group_name                             national character varying(100) NOT NULL UNIQUE,
    audit_user_id                               integer REFERENCES auth.users,
    audit_ts                                    TIMESTAMP WITH TIME ZONE NULL 
                                                DEFAULT(NOW())
);
...
CREATE TABLE wb.menus
(
    menu_id                                     SERIAL NOT NULL PRIMARY KEY,
    menu_group_id                               integer NOT NULL REFERENCES wb.menu_groups,
    sort                                        integer NOT NULL DEFAULT(0),
    menu_name                                   national character varying(40) NOT NULL,
    menu_alias                                  national character varying(50) NOT NULL UNIQUE,
    url                                         national character varying(500) NOT NULL,
    parent_menu_id                              integer REFERENCES wb.menus,
    audit_user_id                               integer REFERENCES auth.users,
    audit_ts                                    TIMESTAMP WITH TIME ZONE NULL 
                                                DEFAULT(NOW())
);
