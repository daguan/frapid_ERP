...
namespace Frapid.Config.Api
{
    ...
    public class ConfigKanbanController : ApiController
    {
        /// <summary>
        ...
        public ConfigKanbanController(IKanbanRepository repository, string catalog, LoginView view)
        {
        ...
        public object AddOrEdit([FromBody]Newtonsoft.Json.Linq.JArray form)
        {
            ...
            List<CustomField> customFields = form[1].ToObject<List<CustomField>>(JsonHelper.GetJsonSerializer());
