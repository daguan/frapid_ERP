...
namespace Frapid.Config.DataAccess
{
    public interface IEmailQueueRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetAll();
        ...
        Frapid.Config.Entities.EmailQueue Get(long queueId);

        /// <summary>
        /// Gets the first record of EmailQueue.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of EmailQueue.</returns>
        Frapid.Config.Entities.EmailQueue GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of EmailQueue.</returns>
        Frapid.Config.Entities.EmailQueue GetPrevious(long queueId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of EmailQueue.</returns>
        Frapid.Config.Entities.EmailQueue GetNext(long queueId);

        /// <summary>
        /// Gets the last record of EmailQueue.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of EmailQueue.</returns>
        Frapid.Config.Entities.EmailQueue GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.EmailQueue> Get(long[] queueIds);
        ...
        object AddOrEdit(dynamic emailQueue, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 EmailQueue classes.
        /// </summary>
        /// <returns>Returns the first page of collection of EmailQueue class.</returns>
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IEmailQueueRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of EmailQueue class.</returns>
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IEmailQueueRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of EmailQueue class.</returns>
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetFiltered(long pageNumber, string filterName);
