...
namespace Frapid.Config.DataAccess
{
    public interface IEmailQueueRepository
    {
        ...
        object AddOrEdit(dynamic emailQueue, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of EmailQueue class.</returns>
        IEnumerable<Frapid.Config.Entities.EmailQueue> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
