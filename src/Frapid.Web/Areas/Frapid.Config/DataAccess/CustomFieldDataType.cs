...
namespace Frapid.Config.DataAccess
{
    ...
    public class CustomFieldDataType : DbAccess, ICustomFieldDataTypeRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.custom_field_data_types" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types ORDER BY data_type LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.custom_field_data_types" producing a paginated result of 50.
        /// </summary>
