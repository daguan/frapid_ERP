...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "config.custom_field_data_types".
    /// </summary>
    public class CustomFieldDataType : DbAccess, ICustomFieldDataTypeRepository
    {
        ...
        /// <summary>
        /// Performs SQL count on the table "config.custom_field_data_types".
        /// </summary>
        /// <returns>Returns the number of rows of the table "config.custom_field_data_types".</returns>
        ...
        public long Count()
        {
            ...
            const string sql = "SELECT COUNT(*) FROM config.custom_field_data_types;";
            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "config.custom_field_data_types" to return all instances of the "CustomFieldDataType" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetAll()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types ORDER BY data_type;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "config.custom_field_data_types" to return all instances of the "CustomFieldDataType" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "CustomFieldDataType" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        /// <summary>
        /// Executes a select query on the table "config.custom_field_data_types" with a where filter on the column "data_type" to return a single instance of the "CustomFieldDataType" class. 
        /// </summary>
        ...
        public Frapid.Config.Entities.CustomFieldDataType Get(string dataType)
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types WHERE data_type=@0;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql, dataType).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "config.custom_field_data_types". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldDataType" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.CustomFieldDataType GetFirst()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types ORDER BY data_type LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "config.custom_field_data_types" sorted by dataType.
        /// </summary>
        ...
        public Frapid.Config.Entities.CustomFieldDataType GetPrevious(string dataType)
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types WHERE data_type < @0 ORDER BY data_type DESC LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql, dataType).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "config.custom_field_data_types" sorted by dataType.
        /// </summary>
        /// <param name="dataType">The column "data_type" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldDataType" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.CustomFieldDataType GetNext(string dataType)
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types WHERE data_type > @0 ORDER BY data_type LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql, dataType).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "config.custom_field_data_types". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldDataType" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.CustomFieldDataType GetLast()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types ORDER BY data_type DESC LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Executes a select query on the table "config.custom_field_data_types" with a where filter on the column "data_type" to return a multiple instances of the "CustomFieldDataType" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> Get(string[] dataTypes)
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types WHERE data_type IN (@0);";

            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql, dataTypes);
        }

        /// <summary>
        /// Custom fields are user defined form elements for config.custom_field_data_types.
        /// </summary>
        /// <returns>Returns an enumerable custom field collection for the table config.custom_field_data_types</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.DataAccess.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM config.custom_field_definition_view WHERE table_name='config.custom_field_data_types' ORDER BY field_order;";
                return Factory.Get<Frapid.DataAccess.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from config.get_custom_field_definition('config.custom_field_data_types'::text, @0::text) ORDER BY field_order;";
            return Factory.Get<Frapid.DataAccess.CustomField>(this._Catalog, sql, resourceId);
        }

        /// <summary>
        /// Displayfields provide a minimal name/value context for data binding the row collection of config.custom_field_data_types.
        /// </summary>
        /// <returns>Returns an enumerable name and value collection for the table config.custom_field_data_types</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.DataAccess.DisplayField> GetDisplayFields()
        {
            ...
            const string sql = "SELECT data_type AS key, is_number as value FROM config.custom_field_data_types;";
        ...
        /// <summary>
        /// Inserts or updates the instance of CustomFieldDataType class on the database table "config.custom_field_data_types".
        /// </summary>
        /// <param name="customFieldDataType">The instance of "CustomFieldDataType" class to insert or update.</param>
        /// <param name="customFields">The custom field collection.</param>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(dynamic customFieldDataType, List<Frapid.DataAccess.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            string sql = "DELETE FROM config.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=config.get_custom_field_form_name('config.custom_field_data_types')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO config.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT config.get_custom_field_setup_id_by_table_name('config.custom_field_data_types', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Inserts the instance of CustomFieldDataType class on the database table "config.custom_field_data_types".
        /// </summary>
        ...
        public object Add(dynamic customFieldDataType)
        {
            ...
            return Factory.Insert(this._Catalog, customFieldDataType, "config.custom_field_data_types", "data_type");
        }

        /// <summary>
        /// Inserts or updates multiple instances of CustomFieldDataType class on the database table "config.custom_field_data_types";
        /// </summary>
                    ...
                    using (ITransaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic customFieldDataType in customFieldDataTypes)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(customFieldDataType.data_type))
                            {
                                ...
                                db.Update("config.custom_field_data_types", "data_type", customFieldDataType, customFieldDataType.data_type);
                            }
                            else
                            {
                                result.Add(db.Insert("config.custom_field_data_types", "data_type", customFieldDataType));
                            }
                        }
        ...
        /// <summary>
        /// Updates the row of the table "config.custom_field_data_types" with an instance of "CustomFieldDataType" class against the primary key value.
        /// </summary>
        ...
        public void Update(dynamic customFieldDataType, string dataType)
        {
            ...
            Factory.Update(this._Catalog, customFieldDataType, dataType, "config.custom_field_data_types", "data_type");
        }

        /// <summary>
        /// Deletes the row of the table "config.custom_field_data_types" against the primary key value.
        /// </summary>
        ...
        public void Delete(string dataType)
        {
            ...
            const string sql = "DELETE FROM config.custom_field_data_types WHERE data_type=@0;";
            Factory.NonQuery(this._Catalog, sql, dataType);
        }

        /// <summary>
        /// Performs a select statement on table "config.custom_field_data_types" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_data_types ORDER BY data_type LIMIT 10 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql);
        }
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<Frapid.Config.Entities.CustomFieldDataType>(this._Catalog, sql, offset);
        }

        public List<Frapid.DataAccess.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM config.filters WHERE object_name='config.custom_field_data_types' AND lower(filter_name)=lower(@0);";
            return Factory.Get<Frapid.DataAccess.Filter>(catalog, sql, filterName).ToList();
        }

        /// <summary>
        /// Performs a filtered count on table "config.custom_field_data_types".
        /// </summary>
        ...
        public long CountWhere(List<Frapid.DataAccess.Filter> filters)
        {
            ...
            Sql sql = Sql.Builder.Append("SELECT COUNT(*) FROM config.custom_field_data_types WHERE 1 = 1");
            Frapid.DataAccess.FilterManager.AddFilters(ref sql, new Frapid.Config.Entities.CustomFieldDataType(), filters);

            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Performs a filtered select statement on table "config.custom_field_data_types" producing a paginated result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "CustomFieldDataType" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            long offset = (pageNumber - 1) * 10;
            Sql sql = Sql.Builder.Append("SELECT * FROM config.custom_field_data_types WHERE 1 = 1");
