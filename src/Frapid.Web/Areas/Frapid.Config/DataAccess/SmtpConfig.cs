...
namespace Frapid.Config.DataAccess
{
    ...
    public class SmtpConfig : DbAccess, ISmtpConfigRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.smtp_configs" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.SmtpConfig> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.smtp_configs ORDER BY smtp_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.SmtpConfig>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.smtp_configs" producing a paginated result of 50.
        /// </summary>
