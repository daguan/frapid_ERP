...
namespace Frapid.Config.DataAccess
{
    public interface ICustomFieldRepository
    {
        ...
        object AddOrEdit(dynamic customField, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of CustomField class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomField> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
