...
namespace Frapid.Config.DataAccess
{
    public interface ISmtpConfigRepository
    {
        ...
        object AddOrEdit(dynamic smtpConfig, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of SmtpConfig class.</returns>
        IEnumerable<Frapid.Config.Entities.SmtpConfig> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
