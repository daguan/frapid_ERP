...
namespace Frapid.Config.DataAccess
{
    public interface ICustomFieldDataTypeRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetAll();
        ...
        Frapid.Config.Entities.CustomFieldDataType Get(string dataType);

        /// <summary>
        /// Gets the first record of CustomFieldDataType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldDataType.</returns>
        Frapid.Config.Entities.CustomFieldDataType GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldDataType.</returns>
        Frapid.Config.Entities.CustomFieldDataType GetPrevious(string dataType);
        ...
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldDataType.</returns>
        Frapid.Config.Entities.CustomFieldDataType GetNext(string dataType);

        /// <summary>
        /// Gets the last record of CustomFieldDataType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldDataType.</returns>
        Frapid.Config.Entities.CustomFieldDataType GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> Get(string[] dataTypes);
        ...
        object AddOrEdit(dynamic customFieldDataType, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 CustomFieldDataType classes.
        /// </summary>
        /// <returns>Returns the first page of collection of CustomFieldDataType class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against ICustomFieldDataTypeRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of CustomFieldDataType class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of ICustomFieldDataTypeRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of CustomFieldDataType class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetFiltered(long pageNumber, string filterName);
