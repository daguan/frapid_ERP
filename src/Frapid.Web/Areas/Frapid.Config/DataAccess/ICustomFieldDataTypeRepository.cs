...
namespace Frapid.Config.DataAccess
{
    public interface ICustomFieldDataTypeRepository
    {
        ...
        object AddOrEdit(dynamic customFieldDataType, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of CustomFieldDataType class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldDataType> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
