...
namespace Frapid.Config.DataAccess
{
    ...
    public class EmailQueue : DbAccess, IEmailQueueRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.email_queue" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.EmailQueue> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.email_queue ORDER BY queue_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.email_queue" producing a paginated result of 50.
        /// </summary>
