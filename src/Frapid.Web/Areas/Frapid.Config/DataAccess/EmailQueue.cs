...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "config.email_queue".
    /// </summary>
    public class EmailQueue : DbAccess, IEmailQueueRepository
    {
        ...
        /// <summary>
        /// Performs SQL count on the table "config.email_queue".
        /// </summary>
        /// <returns>Returns the number of rows of the table "config.email_queue".</returns>
        ...
        public long Count()
        {
            ...
            const string sql = "SELECT COUNT(*) FROM config.email_queue;";
            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "config.email_queue" to return all instances of the "EmailQueue" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.EmailQueue> GetAll()
        {
            ...
            const string sql = "SELECT * FROM config.email_queue ORDER BY queue_id;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "config.email_queue" to return all instances of the "EmailQueue" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "EmailQueue" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        /// <summary>
        /// Executes a select query on the table "config.email_queue" with a where filter on the column "queue_id" to return a single instance of the "EmailQueue" class. 
        /// </summary>
        ...
        public Frapid.Config.Entities.EmailQueue Get(long queueId)
        {
            ...
            const string sql = "SELECT * FROM config.email_queue WHERE queue_id=@0;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql, queueId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "config.email_queue". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "EmailQueue" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.EmailQueue GetFirst()
        {
            ...
            const string sql = "SELECT * FROM config.email_queue ORDER BY queue_id LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "config.email_queue" sorted by queueId.
        /// </summary>
        ...
        public Frapid.Config.Entities.EmailQueue GetPrevious(long queueId)
        {
            ...
            const string sql = "SELECT * FROM config.email_queue WHERE queue_id < @0 ORDER BY queue_id DESC LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql, queueId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "config.email_queue" sorted by queueId.
        /// </summary>
        /// <param name="queueId">The column "queue_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "EmailQueue" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.EmailQueue GetNext(long queueId)
        {
            ...
            const string sql = "SELECT * FROM config.email_queue WHERE queue_id > @0 ORDER BY queue_id LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql, queueId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "config.email_queue". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "EmailQueue" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public Frapid.Config.Entities.EmailQueue GetLast()
        {
            ...
            const string sql = "SELECT * FROM config.email_queue ORDER BY queue_id DESC LIMIT 1;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Executes a select query on the table "config.email_queue" with a where filter on the column "queue_id" to return a multiple instances of the "EmailQueue" class. 
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.EmailQueue> Get(long[] queueIds)
        {
            ...
            const string sql = "SELECT * FROM config.email_queue WHERE queue_id IN (@0);";

            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql, queueIds);
        }

        /// <summary>
        /// Custom fields are user defined form elements for config.email_queue.
        /// </summary>
        /// <returns>Returns an enumerable custom field collection for the table config.email_queue</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.DataAccess.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM config.custom_field_definition_view WHERE table_name='config.email_queue' ORDER BY field_order;";
                return Factory.Get<Frapid.DataAccess.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from config.get_custom_field_definition('config.email_queue'::text, @0::text) ORDER BY field_order;";
            return Factory.Get<Frapid.DataAccess.CustomField>(this._Catalog, sql, resourceId);
        }

        /// <summary>
        /// Displayfields provide a minimal name/value context for data binding the row collection of config.email_queue.
        /// </summary>
        /// <returns>Returns an enumerable name and value collection for the table config.email_queue</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        /// <summary>
        /// Inserts or updates the instance of EmailQueue class on the database table "config.email_queue".
        /// </summary>
        /// <param name="emailQueue">The instance of "EmailQueue" class to insert or update.</param>
        /// <param name="customFields">The custom field collection.</param>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(dynamic emailQueue, List<Frapid.DataAccess.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            {
                this.Update(emailQueue, Cast.To<long>(primaryKeyValue));
            }
            else
            {
            ...
            string sql = "DELETE FROM config.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=config.get_custom_field_form_name('config.email_queue')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO config.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT config.get_custom_field_setup_id_by_table_name('config.email_queue', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Inserts the instance of EmailQueue class on the database table "config.email_queue".
        /// </summary>
        ...
        public object Add(dynamic emailQueue)
        {
            ...
            return Factory.Insert(this._Catalog, emailQueue, "config.email_queue", "queue_id");
        }

        /// <summary>
        /// Inserts or updates multiple instances of EmailQueue class on the database table "config.email_queue";
        /// </summary>
                    ...
                    using (ITransaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic emailQueue in emailQueues)
                        {
                            ...
                            if (Cast.To<long>(primaryKeyValue) > 0)
                            {
                                ...
                                db.Update("config.email_queue", "queue_id", emailQueue, emailQueue.queue_id);
                            }
                            else
                            {
                                result.Add(db.Insert("config.email_queue", "queue_id", emailQueue));
                            }
                        }
        ...
        /// <summary>
        /// Updates the row of the table "config.email_queue" with an instance of "EmailQueue" class against the primary key value.
        /// </summary>
        ...
        public void Update(dynamic emailQueue, long queueId)
        {
            ...
            Factory.Update(this._Catalog, emailQueue, queueId, "config.email_queue", "queue_id");
        }

        /// <summary>
        /// Deletes the row of the table "config.email_queue" against the primary key value.
        /// </summary>
        ...
        public void Delete(long queueId)
        {
            ...
            const string sql = "DELETE FROM config.email_queue WHERE queue_id=@0;";
            Factory.NonQuery(this._Catalog, sql, queueId);
        }

        /// <summary>
        /// Performs a select statement on table "config.email_queue" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.EmailQueue> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.email_queue ORDER BY queue_id LIMIT 10 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql);
        }
        ...
        public IEnumerable<Frapid.Config.Entities.EmailQueue> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<Frapid.Config.Entities.EmailQueue>(this._Catalog, sql, offset);
        }

        public List<Frapid.DataAccess.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM config.filters WHERE object_name='config.email_queue' AND lower(filter_name)=lower(@0);";
            return Factory.Get<Frapid.DataAccess.Filter>(catalog, sql, filterName).ToList();
        }

        /// <summary>
        /// Performs a filtered count on table "config.email_queue".
        /// </summary>
        ...
        public long CountWhere(List<Frapid.DataAccess.Filter> filters)
        {
            ...
            Sql sql = Sql.Builder.Append("SELECT COUNT(*) FROM config.email_queue WHERE 1 = 1");
            Frapid.DataAccess.FilterManager.AddFilters(ref sql, new Frapid.Config.Entities.EmailQueue(), filters);

            return Factory.Scalar<long>(this._Catalog, sql);
        }

        /// <summary>
        /// Performs a filtered select statement on table "config.email_queue" producing a paginated result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "EmailQueue" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<Frapid.Config.Entities.EmailQueue> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            long offset = (pageNumber - 1) * 10;
            Sql sql = Sql.Builder.Append("SELECT * FROM config.email_queue WHERE 1 = 1");
