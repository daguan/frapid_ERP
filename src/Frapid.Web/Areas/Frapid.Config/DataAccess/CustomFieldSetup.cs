...
namespace Frapid.Config.DataAccess
{
    ...
    public class CustomFieldSetup : DbAccess, ICustomFieldSetupRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.custom_field_setup" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_setup ORDER BY custom_field_setup_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldSetup>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.custom_field_setup" producing a paginated result of 50.
        /// </summary>
