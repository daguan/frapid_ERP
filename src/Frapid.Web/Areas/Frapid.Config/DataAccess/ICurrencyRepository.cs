...
namespace Frapid.Config.DataAccess
{
    public interface ICurrencyRepository
    {
        ...
        object AddOrEdit(dynamic currency, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Currency class.</returns>
        IEnumerable<Frapid.Config.Entities.Currency> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
