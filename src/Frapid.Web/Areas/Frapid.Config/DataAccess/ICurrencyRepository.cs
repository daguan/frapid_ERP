...
namespace Frapid.Config.DataAccess
{
    public interface ICurrencyRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.Currency> GetAll();
        ...
        Frapid.Config.Entities.Currency Get(string currencyCode);

        /// <summary>
        /// Gets the first record of Currency.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Currency.</returns>
        Frapid.Config.Entities.Currency GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Currency.</returns>
        Frapid.Config.Entities.Currency GetPrevious(string currencyCode);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Currency.</returns>
        Frapid.Config.Entities.Currency GetNext(string currencyCode);

        /// <summary>
        /// Gets the last record of Currency.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Currency.</returns>
        Frapid.Config.Entities.Currency GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.Currency> Get(string[] currencyCodes);
        ...
        object AddOrEdit(dynamic currency, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        IEnumerable<Frapid.Config.Entities.Currency> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.Currency> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Currency class.</returns>
        IEnumerable<Frapid.Config.Entities.Currency> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Currency class.</returns>
        IEnumerable<Frapid.Config.Entities.Currency> GetFiltered(long pageNumber, string filterName);
