...
namespace Frapid.Config.DataAccess
{
    ...
    public class Filter : DbAccess, IFilterRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.filters" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.Filter> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.filters ORDER BY filter_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.Filter>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.filters" producing a paginated result of 50.
        /// </summary>
