...
namespace Frapid.Config.DataAccess
{
    public interface IFlagRepository
    {
        ...
        object AddOrEdit(dynamic flag, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Flag class.</returns>
        IEnumerable<Frapid.Config.Entities.Flag> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
