...
namespace Frapid.Config.DataAccess
{
    public interface IFlagRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.Flag> GetAll();
        ...
        Frapid.Config.Entities.Flag Get(long flagId);

        /// <summary>
        /// Gets the first record of Flag.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Flag.</returns>
        Frapid.Config.Entities.Flag GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Flag.</returns>
        Frapid.Config.Entities.Flag GetPrevious(long flagId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Flag.</returns>
        Frapid.Config.Entities.Flag GetNext(long flagId);

        /// <summary>
        /// Gets the last record of Flag.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Flag.</returns>
        Frapid.Config.Entities.Flag GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.Flag> Get(long[] flagIds);
        ...
        object AddOrEdit(dynamic flag, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 Flag classes.
        /// </summary>
        /// <returns>Returns the first page of collection of Flag class.</returns>
        IEnumerable<Frapid.Config.Entities.Flag> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.Flag> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IFlagRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Flag class.</returns>
        IEnumerable<Frapid.Config.Entities.Flag> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IFlagRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Flag class.</returns>
        IEnumerable<Frapid.Config.Entities.Flag> GetFiltered(long pageNumber, string filterName);
