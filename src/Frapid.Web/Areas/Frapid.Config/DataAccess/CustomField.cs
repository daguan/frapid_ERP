...
namespace Frapid.Config.DataAccess
{
    ...
    public class CustomField : DbAccess, ICustomFieldRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.custom_fields" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomField> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.custom_fields ORDER BY custom_field_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.CustomField>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.custom_fields" producing a paginated result of 50.
        /// </summary>
