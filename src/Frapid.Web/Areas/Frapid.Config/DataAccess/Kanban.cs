...
namespace Frapid.Config.DataAccess
{
    ...
    public class Kanban : DbAccess, IKanbanRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.kanbans" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.Kanban> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.kanbans ORDER BY kanban_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.Kanban>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.kanbans" producing a paginated result of 50.
        /// </summary>
