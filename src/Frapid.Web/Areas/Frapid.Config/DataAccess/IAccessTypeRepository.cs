...
namespace Frapid.Config.DataAccess
{
    public interface IAccessTypeRepository
    {
        ...
        object AddOrEdit(dynamic accessType, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of AccessType class.</returns>
        IEnumerable<Frapid.Config.Entities.AccessType> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
