...
namespace Frapid.Config.DataAccess
{
    public interface IAccessTypeRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.AccessType> GetAll();
        ...
        Frapid.Config.Entities.AccessType Get(int accessTypeId);

        /// <summary>
        /// Gets the first record of AccessType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of AccessType.</returns>
        Frapid.Config.Entities.AccessType GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of AccessType.</returns>
        Frapid.Config.Entities.AccessType GetPrevious(int accessTypeId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of AccessType.</returns>
        Frapid.Config.Entities.AccessType GetNext(int accessTypeId);

        /// <summary>
        /// Gets the last record of AccessType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of AccessType.</returns>
        Frapid.Config.Entities.AccessType GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.AccessType> Get(int[] accessTypeIds);
        ...
        object AddOrEdit(dynamic accessType, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        IEnumerable<Frapid.Config.Entities.AccessType> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.AccessType> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of AccessType class.</returns>
        IEnumerable<Frapid.Config.Entities.AccessType> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of AccessType class.</returns>
        IEnumerable<Frapid.Config.Entities.AccessType> GetFiltered(long pageNumber, string filterName);
