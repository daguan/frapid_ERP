...
namespace Frapid.Config.DataAccess
{
    public interface IAppDependencyRepository
    {
        ...
        object AddOrEdit(dynamic appDependency, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of AppDependency class.</returns>
        IEnumerable<Frapid.Config.Entities.AppDependency> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
