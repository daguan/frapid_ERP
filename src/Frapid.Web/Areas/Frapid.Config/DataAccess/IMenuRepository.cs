...
namespace Frapid.Config.DataAccess
{
    public interface IMenuRepository
    {
        ...
        object AddOrEdit(dynamic menu, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.Config.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
