...
namespace Frapid.Config.DataAccess
{
    public interface IMenuRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.Menu> GetAll();
        ...
        Frapid.Config.Entities.Menu Get(int menuId);

        /// <summary>
        /// Gets the first record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Config.Entities.Menu GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Config.Entities.Menu GetPrevious(int menuId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Config.Entities.Menu GetNext(int menuId);

        /// <summary>
        /// Gets the last record of Menu.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Menu.</returns>
        Frapid.Config.Entities.Menu GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.Menu> Get(int[] menuIds);
        ...
        IEnumerable<Frapid.Config.Entities.Menu> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.Menu> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.Config.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Menu class.</returns>
        IEnumerable<Frapid.Config.Entities.Menu> GetFiltered(long pageNumber, string filterName);
