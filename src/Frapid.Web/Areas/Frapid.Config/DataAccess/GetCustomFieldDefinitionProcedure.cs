...
{
    /// <summary>
    /// Prepares, validates, and executes the function "config.get_custom_field_definition(_table_name text, _resource_id text)" on the database.
    /// </summary>
    public class GetCustomFieldDefinitionProcedure : DbAccess, IGetCustomFieldDefinitionRepository
    {
        ...
        /// <summary>
        /// Maps to "_table_name" argument of the function "config.get_custom_field_definition".
        /// </summary>
        public string TableName { get; set; }
        /// <summary>
        /// Maps to "_resource_id" argument of the function "config.get_custom_field_definition".
        /// </summary>
        ...
        /// Prepares, validates, and executes the function "config.get_custom_field_definition(_table_name text, _resource_id text)" on the database.
        /// </summary>
        /// <param name="tableName">Enter argument value for "_table_name" parameter of the function "config.get_custom_field_definition".</param>
        /// <param name="resourceId">Enter argument value for "_resource_id" parameter of the function "config.get_custom_field_definition".</param>
        ...
        /// <summary>
        /// Prepares and executes the function "config.get_custom_field_definition".
        /// </summary>
        ...
        public IEnumerable<DbGetCustomFieldDefinitionResult> Execute()
        {
            ...
            string query = "SELECT * FROM config.get_custom_field_definition(@TableName, @ResourceId);";
