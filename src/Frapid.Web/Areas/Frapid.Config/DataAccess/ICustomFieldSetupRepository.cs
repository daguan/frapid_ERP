...
namespace Frapid.Config.DataAccess
{
    public interface ICustomFieldSetupRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetAll();
        ...
        Frapid.Config.Entities.CustomFieldSetup Get(int customFieldSetupId);

        /// <summary>
        /// Gets the first record of CustomFieldSetup.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldSetup.</returns>
        Frapid.Config.Entities.CustomFieldSetup GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldSetup.</returns>
        Frapid.Config.Entities.CustomFieldSetup GetPrevious(int customFieldSetupId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldSetup.</returns>
        Frapid.Config.Entities.CustomFieldSetup GetNext(int customFieldSetupId);

        /// <summary>
        /// Gets the last record of CustomFieldSetup.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of CustomFieldSetup.</returns>
        Frapid.Config.Entities.CustomFieldSetup GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> Get(int[] customFieldSetupIds);
        ...
        object AddOrEdit(dynamic customFieldSetup, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 CustomFieldSetup classes.
        /// </summary>
        /// <returns>Returns the first page of collection of CustomFieldSetup class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against ICustomFieldSetupRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of CustomFieldSetup class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of ICustomFieldSetupRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of CustomFieldSetup class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetFiltered(long pageNumber, string filterName);
