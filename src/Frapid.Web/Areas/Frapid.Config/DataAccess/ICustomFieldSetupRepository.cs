...
namespace Frapid.Config.DataAccess
{
    public interface ICustomFieldSetupRepository
    {
        ...
        object AddOrEdit(dynamic customFieldSetup, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of CustomFieldSetup class.</returns>
        IEnumerable<Frapid.Config.Entities.CustomFieldSetup> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
