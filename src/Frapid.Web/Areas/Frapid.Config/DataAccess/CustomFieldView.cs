...
namespace Frapid.Config.DataAccess
{
    ...
    public class CustomFieldView : DbAccess, ICustomFieldViewRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "config.custom_field_view" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.CustomFieldView> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.custom_field_view ORDER BY 1 LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.CustomFieldView>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on view "config.custom_field_view" producing a paginated result of 50.
        /// </summary>
