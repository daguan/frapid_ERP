...
namespace Frapid.Config.DataAccess
{
    ...
    public class FlagType : DbAccess, IFlagTypeRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.flag_types" producing a paginated result of 50.
        /// </summary>
        ...
        public IEnumerable<Frapid.Config.Entities.FlagType> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM config.flag_types ORDER BY flag_type_id LIMIT 50 OFFSET 0;";
            return Factory.Get<Frapid.Config.Entities.FlagType>(this._Catalog, sql);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.flag_types" producing a paginated result of 50.
        /// </summary>
