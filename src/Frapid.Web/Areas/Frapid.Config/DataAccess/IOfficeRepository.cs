...
namespace Frapid.Config.DataAccess
{
    public interface IOfficeRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.Office> GetAll();
        ...
        Frapid.Config.Entities.Office Get(int officeId);

        /// <summary>
        /// Gets the first record of Office.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Config.Entities.Office GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Config.Entities.Office GetPrevious(int officeId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Config.Entities.Office GetNext(int officeId);

        /// <summary>
        /// Gets the last record of Office.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Office.</returns>
        Frapid.Config.Entities.Office GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.Office> Get(int[] officeIds);
        ...
        IEnumerable<Frapid.Config.Entities.Office> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.Office> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Office class.</returns>
        IEnumerable<Frapid.Config.Entities.Office> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Office class.</returns>
        IEnumerable<Frapid.Config.Entities.Office> GetFiltered(long pageNumber, string filterName);
