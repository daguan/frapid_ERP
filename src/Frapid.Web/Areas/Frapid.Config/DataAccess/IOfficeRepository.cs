...
namespace Frapid.Config.DataAccess
{
    public interface IOfficeRepository
    {
        ...
        object AddOrEdit(dynamic office, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Office class.</returns>
        IEnumerable<Frapid.Config.Entities.Office> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
