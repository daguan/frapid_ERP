...
namespace Frapid.Config.DataAccess
{
    public interface IFlagTypeRepository
    {
        ...
        object AddOrEdit(dynamic flagType, List<Frapid.DataAccess.CustomField> customFields);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of FlagType class.</returns>
        IEnumerable<Frapid.Config.Entities.FlagType> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters);
