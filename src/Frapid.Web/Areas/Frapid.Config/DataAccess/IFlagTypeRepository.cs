...
namespace Frapid.Config.DataAccess
{
    public interface IFlagTypeRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.FlagType> GetAll();
        ...
        Frapid.Config.Entities.FlagType Get(int flagTypeId);

        /// <summary>
        /// Gets the first record of FlagType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of FlagType.</returns>
        Frapid.Config.Entities.FlagType GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of FlagType.</returns>
        Frapid.Config.Entities.FlagType GetPrevious(int flagTypeId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of FlagType.</returns>
        Frapid.Config.Entities.FlagType GetNext(int flagTypeId);

        /// <summary>
        /// Gets the last record of FlagType.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of FlagType.</returns>
        Frapid.Config.Entities.FlagType GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.FlagType> Get(int[] flagTypeIds);
        ...
        object AddOrEdit(dynamic flagType, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 FlagType classes.
        /// </summary>
        /// <returns>Returns the first page of collection of FlagType class.</returns>
        IEnumerable<Frapid.Config.Entities.FlagType> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.FlagType> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IFlagTypeRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of FlagType class.</returns>
        IEnumerable<Frapid.Config.Entities.FlagType> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IFlagTypeRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of FlagType class.</returns>
        IEnumerable<Frapid.Config.Entities.FlagType> GetFiltered(long pageNumber, string filterName);
