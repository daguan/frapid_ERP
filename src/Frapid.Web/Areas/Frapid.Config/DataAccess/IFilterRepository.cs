...
namespace Frapid.Config.DataAccess
{
    public interface IFilterRepository
    {
        ...
        IEnumerable<Frapid.Config.Entities.Filter> GetAll();
        ...
        Frapid.Config.Entities.Filter Get(long filterId);

        /// <summary>
        /// Gets the first record of Filter.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Filter.</returns>
        Frapid.Config.Entities.Filter GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of Filter.</returns>
        Frapid.Config.Entities.Filter GetPrevious(long filterId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of Filter.</returns>
        Frapid.Config.Entities.Filter GetNext(long filterId);

        /// <summary>
        /// Gets the last record of Filter.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of Filter.</returns>
        Frapid.Config.Entities.Filter GetLast();
        ...
        IEnumerable<Frapid.Config.Entities.Filter> Get(long[] filterIds);
        ...
        object AddOrEdit(dynamic filter, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        /// <summary>
        /// Produces a paginated result of 50 Filter classes.
        /// </summary>
        /// <returns>Returns the first page of collection of Filter class.</returns>
        IEnumerable<Frapid.Config.Entities.Filter> GetPaginatedResult();
        ...
        IEnumerable<Frapid.Config.Entities.Filter> GetPaginatedResult(long pageNumber);
        ...
        /// <summary>
        /// Performs a filtered pagination against IFilterRepository producing result of 50 items.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of Filter class.</returns>
        IEnumerable<Frapid.Config.Entities.Filter> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <summary>
        /// Gets a filtered result of IFilterRepository producing a paginated result of 50.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paginated result. If you provide a negative number, the result will not be paginated.</param>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of Filter class.</returns>
        IEnumerable<Frapid.Config.Entities.Filter> GetFiltered(long pageNumber, string filterName);
        ...
        void RecreateFilters(string objectName, string filterName, List<Frapid.Config.Entities.Filter> filters);
