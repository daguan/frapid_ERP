                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "logo",  PropertyName = "Logo",  DataType = "string",  DbDataType = "image",  IsNullable = true,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
