...
namespace Frapid.Config.Api
{
    ...
    public class FlagController : FrapidApiController
    {
        ...
        public FlagController(IFlagRepository repository)
        {
        ...
        public EntityView GetEntityView()
        {
            return new EntityView
            {
                ...
                Columns = new List<EntityColumn>()
                {
                        ...
                        new EntityColumn
                        {
                                ColumnName = "flagged_on",
                                PropertyName = "FlaggedOn",
                                DataType = "DateTime",
        ...
        /// <summary>
        ///     Creates a paginated collection containing 50 flags on each page, sorted by the property FlagId.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 50 flags on each page, sorted by the property FlagId.
        /// </summary>
        ...
        public object AddOrEdit([FromBody]Newtonsoft.Json.Linq.JArray form)
        {
            ...
            try
            {
                flag.user_id = this.MetaUser.UserId;
        ...
        public void Add(Frapid.Config.Entities.Flag flag)
        {
            ...
            try
            {
                flag.UserId = this.MetaUser.UserId;
