...
namespace Frapid.Config.Api
{
    ...
    public class CustomFieldDataTypeController : FrapidApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 50 custom field data types on each page, sorted by the property DataType.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 50 custom field data types on each page, sorted by the property DataType.
        /// </summary>
