...
namespace Frapid.Config.Api.Fakes
{
    public class MenuRepository : IMenuRepository
    {
        ...
        public IEnumerable<Frapid.Config.Entities.Menu> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            return Enumerable.Repeat(new Frapid.Config.Entities.Menu(), 1);
        }
        ...
        public object AddOrEdit(dynamic menu, List<Frapid.DataAccess.CustomField> customFields)
        {
            return true;
        }
