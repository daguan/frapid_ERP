...
namespace Frapid.Config.Api.Fakes
{
    public class DefaultEntityAccessRepository : IDefaultEntityAccessRepository
    {
        ...
        public IEnumerable<Frapid.Config.Entities.DefaultEntityAccess> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            return Enumerable.Repeat(new Frapid.Config.Entities.DefaultEntityAccess(), 1);
        }
        ...
        public object AddOrEdit(dynamic defaultEntityAccess, List<Frapid.DataAccess.CustomField> customFields)
        {
            return true;
        }
