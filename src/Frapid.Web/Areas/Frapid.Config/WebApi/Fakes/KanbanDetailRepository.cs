...
namespace Frapid.Config.Api.Fakes
{
    public class KanbanDetailRepository : IKanbanDetailRepository
    {
        ...
        public IEnumerable<Frapid.Config.Entities.KanbanDetail> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            return Enumerable.Repeat(new Frapid.Config.Entities.KanbanDetail(), 1);
        }
        ...
        public object AddOrEdit(dynamic kanbanDetail, List<Frapid.DataAccess.CustomField> customFields)
        {
            return true;
        }
