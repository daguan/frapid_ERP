...
namespace Frapid.Config.Api.Fakes
{
    public class OfficeRepository : IOfficeRepository
    {
        ...
        public IEnumerable<Frapid.Config.Entities.Office> GetWhere(long pageNumber, List<Frapid.DataAccess.Filter> filters)
        {
            return Enumerable.Repeat(new Frapid.Config.Entities.Office(), 1);
        }
        ...
        public object AddOrEdit(dynamic office, List<Frapid.DataAccess.CustomField> customFields)
        {
            return true;
        }
