...
namespace Frapid.Config.Api
{
    ...
    public class FlagViewController : FrapidApiController
    {
        ...
        /// </summary>
        private IFlagViewRepository FlagViewRepository;

        public FlagViewController()
        {
        }

        public FlagViewController(IFlagViewRepository repository)
        {
        ...
        protected override void Initialize(HttpControllerContext context)
        {
            ...
            if (this.FlagViewRepository == null)
            {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 50 flag views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 50 flag views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
