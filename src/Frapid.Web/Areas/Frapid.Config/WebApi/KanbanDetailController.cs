...
namespace Frapid.Config.Api
{
    ...
    public class KanbanDetailController : FrapidApiController
    {
        ...
        /// </summary>
        private IKanbanDetailRepository KanbanDetailRepository;

        public KanbanDetailController()
        {
        }

        public KanbanDetailController(IKanbanDetailRepository repository)
        {
        ...
        protected override void Initialize(HttpControllerContext context)
        {
            ...
            if (this.KanbanDetailRepository == null)
            {
        ...
        public EntityView GetEntityView()
        {
            return new EntityView
            {
                ...
                Columns = new List<EntityColumn>()
                {
                        new EntityColumn
                        {
                                ColumnName = "kanban_detail_id",
                                PropertyName = "KanbanDetailId",
                                DataType = "long",
                                DbDataType = "int8",
                                IsNullable = false,
                                IsPrimaryKey = true,
        ...
        /// <summary>
        ///     Creates a paginated collection containing 50 kanban details on each page, sorted by the property KanbanDetailId.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 50 kanban details on each page, sorted by the property KanbanDetailId.
        /// </summary>
