...
namespace Frapid.Config.Api
{
    ...
    public class CustomFieldDefinitionViewController : FrapidApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 50 custom field definition views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 50 custom field definition views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
