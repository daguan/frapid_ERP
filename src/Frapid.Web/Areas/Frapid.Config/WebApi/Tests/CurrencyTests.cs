...
namespace Frapid.Config.Api.Tests
{
    public class CurrencyTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.Currency currency = Fixture().Get(string.Empty);
        ...
        public void First()
        {
            Frapid.Config.Entities.Currency currency = Fixture().GetFirst();
            Assert.NotNull(currency);
        }
        ...
        {
            Frapid.Config.Entities.Currency currency = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(currency);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.Currency> currencies = Fixture().Get(new string[] { });
