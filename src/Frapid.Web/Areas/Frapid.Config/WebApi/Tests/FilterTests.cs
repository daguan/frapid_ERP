...
namespace Frapid.Config.Api.Tests
{
    public class FilterTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.Filter filter = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.Filter filter = Fixture().GetFirst();
            Assert.NotNull(filter);
        }
        ...
        {
            Frapid.Config.Entities.Filter filter = Fixture().GetPrevious(0);
            Assert.NotNull(filter);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.Filter filter = Fixture().GetNext(0);
            Assert.NotNull(filter);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.Filter filter = Fixture().GetLast();
            Assert.NotNull(filter);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.Filter> filters = Fixture().Get(new long[] { });
