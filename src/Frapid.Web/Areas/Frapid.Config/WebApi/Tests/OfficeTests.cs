...
namespace Frapid.Config.Api.Tests
{
    public class OfficeTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.Office office = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.Office office = Fixture().GetFirst();
            Assert.NotNull(office);
        }
        ...
        {
            Frapid.Config.Entities.Office office = Fixture().GetPrevious(0);
            Assert.NotNull(office);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.Office office = Fixture().GetNext(0);
            Assert.NotNull(office);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.Office office = Fixture().GetLast();
            Assert.NotNull(office);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.Office> offices = Fixture().Get(new int[] { });
