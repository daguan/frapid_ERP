...
namespace Frapid.Config.Api.Tests
{
    public class SmtpConfigTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.SmtpConfig smtpConfig = Fixture().Get(0);
            Assert.NotNull(smtpConfig);
        }
        ...
        public void First()
        {
            Frapid.Config.Entities.SmtpConfig smtpConfig = Fixture().GetFirst();
            Assert.NotNull(smtpConfig);
        }
        ...
        {
            Frapid.Config.Entities.SmtpConfig smtpConfig = Fixture().GetPrevious(0);
            Assert.NotNull(smtpConfig);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.SmtpConfig smtpConfig = Fixture().GetNext(0);
            Assert.NotNull(smtpConfig);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.SmtpConfig smtpConfig = Fixture().GetLast();
            Assert.NotNull(smtpConfig);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.SmtpConfig> smtpConfigs = Fixture().Get(new int[] { });
            Assert.NotNull(smtpConfigs);
        }
