...
namespace Frapid.Config.Api.Tests
{
    public class FlagTypeTests
    {
        ...
        {
            FlagTypeController controller = new FlagTypeController(new FlagTypeRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Config.Entities.FlagType flagType = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.FlagType flagType = Fixture().GetFirst();
            Assert.NotNull(flagType);
        }
        ...
        {
            Frapid.Config.Entities.FlagType flagType = Fixture().GetPrevious(0);
            Assert.NotNull(flagType);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.FlagType flagType = Fixture().GetNext(0);
            Assert.NotNull(flagType);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.FlagType flagType = Fixture().GetLast();
            Assert.NotNull(flagType);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.FlagType> flagTypes = Fixture().Get(new int[] { });
