...
namespace Frapid.Config.Api.Tests
{
    public class CustomFieldDataTypeTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.CustomFieldDataType customFieldDataType = Fixture().Get(string.Empty);
        ...
        public void First()
        {
            Frapid.Config.Entities.CustomFieldDataType customFieldDataType = Fixture().GetFirst();
            Assert.NotNull(customFieldDataType);
        }
        ...
        {
            Frapid.Config.Entities.CustomFieldDataType customFieldDataType = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(customFieldDataType);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.CustomFieldDataType customFieldDataType = Fixture().GetNext(string.Empty);
            Assert.NotNull(customFieldDataType);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.CustomFieldDataType customFieldDataType = Fixture().GetLast();
            Assert.NotNull(customFieldDataType);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.CustomFieldDataType> customFieldDataTypes = Fixture().Get(new string[] { });
