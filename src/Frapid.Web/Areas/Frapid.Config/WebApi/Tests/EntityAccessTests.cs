...
namespace Frapid.Config.Api.Tests
{
    public class EntityAccessTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.EntityAccess entityAccess = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.EntityAccess entityAccess = Fixture().GetFirst();
            Assert.NotNull(entityAccess);
        }
        ...
        {
            Frapid.Config.Entities.EntityAccess entityAccess = Fixture().GetPrevious(0);
            Assert.NotNull(entityAccess);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.EntityAccess entityAccess = Fixture().GetNext(0);
            Assert.NotNull(entityAccess);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.EntityAccess entityAccess = Fixture().GetLast();
            Assert.NotNull(entityAccess);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.EntityAccess> entityAccesses = Fixture().Get(new int[] { });
