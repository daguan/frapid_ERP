...
namespace Frapid.Config.Api.Tests
{
    public class MenuTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.Menu menu = Fixture().Get(0);
            Assert.NotNull(menu);
        }
        ...
        public void First()
        {
            Frapid.Config.Entities.Menu menu = Fixture().GetFirst();
            Assert.NotNull(menu);
        }
        ...
        {
            Frapid.Config.Entities.Menu menu = Fixture().GetPrevious(0);
            Assert.NotNull(menu);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.Menu menu = Fixture().GetNext(0);
            Assert.NotNull(menu);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.Menu menu = Fixture().GetLast();
            Assert.NotNull(menu);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.Menu> menus = Fixture().Get(new int[] { });
