...
namespace Frapid.Config.Api.Tests
{
    public class AppTests
    {
        ...
        {
            AppController controller = new AppController(new AppRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Config.Entities.App app = Fixture().Get(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void First()
        {
            Frapid.Config.Entities.App app = Fixture().GetFirst();
            Assert.NotNull(app);
        }
        ...
        {
            Frapid.Config.Entities.App app = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.App app = Fixture().GetNext(string.Empty);
            Assert.NotNull(app);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.App app = Fixture().GetLast();
            Assert.NotNull(app);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.App> apps = Fixture().Get(new string[] { });
            Assert.NotNull(apps);
        }
