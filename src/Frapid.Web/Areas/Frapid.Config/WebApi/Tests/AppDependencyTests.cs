...
namespace Frapid.Config.Api.Tests
{
    ...
    {
        public static AppDependencyController Fixture()
        {
            AppDependencyController controller = new AppDependencyController(new AppDependencyRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Config.Entities.AppDependency appDependency = Fixture().Get(0);
            Assert.NotNull(appDependency);
        }
        ...
        public void First()
        {
            Frapid.Config.Entities.AppDependency appDependency = Fixture().GetFirst();
            Assert.NotNull(appDependency);
        }
        ...
        {
            Frapid.Config.Entities.AppDependency appDependency = Fixture().GetPrevious(0);
            Assert.NotNull(appDependency);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.AppDependency appDependency = Fixture().GetNext(0);
            Assert.NotNull(appDependency);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.AppDependency appDependency = Fixture().GetLast();
            Assert.NotNull(appDependency);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.AppDependency> appDependencies = Fixture().Get(new int[] { });
            Assert.NotNull(appDependencies);
        }
