...
namespace Frapid.Config.Api.Tests
{
    public class KanbanDetailTests
    {
        ...
        {
            KanbanDetailController controller = new KanbanDetailController(new KanbanDetailRepository());
            return controller;
        }
        ...
        public void Get()
        {
            Frapid.Config.Entities.KanbanDetail kanbanDetail = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.KanbanDetail kanbanDetail = Fixture().GetFirst();
            Assert.NotNull(kanbanDetail);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.KanbanDetail kanbanDetail = Fixture().GetNext(0);
            Assert.NotNull(kanbanDetail);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.KanbanDetail> kanbanDetails = Fixture().Get(new long[] { });
