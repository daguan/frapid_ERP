...
namespace Frapid.Config.Api.Tests
{
    public class DefaultEntityAccessTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.DefaultEntityAccess defaultEntityAccess = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.DefaultEntityAccess defaultEntityAccess = Fixture().GetFirst();
            Assert.NotNull(defaultEntityAccess);
        }
        ...
        {
            Frapid.Config.Entities.DefaultEntityAccess defaultEntityAccess = Fixture().GetPrevious(0);
            Assert.NotNull(defaultEntityAccess);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.DefaultEntityAccess defaultEntityAccess = Fixture().GetNext(0);
            Assert.NotNull(defaultEntityAccess);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.DefaultEntityAccess defaultEntityAccess = Fixture().GetLast();
            Assert.NotNull(defaultEntityAccess);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.DefaultEntityAccess> defaultEntityAccesses = Fixture().Get(new int[] { });
