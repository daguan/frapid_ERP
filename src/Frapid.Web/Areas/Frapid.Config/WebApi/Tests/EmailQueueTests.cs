...
namespace Frapid.Config.Api.Tests
{
    public class EmailQueueTests
    {
        ...
        public void Get()
        {
            Frapid.Config.Entities.EmailQueue emailQueue = Fixture().Get(0);
        ...
        public void First()
        {
            Frapid.Config.Entities.EmailQueue emailQueue = Fixture().GetFirst();
            Assert.NotNull(emailQueue);
        }
        ...
        {
            Frapid.Config.Entities.EmailQueue emailQueue = Fixture().GetPrevious(0);
            Assert.NotNull(emailQueue);
        }
        ...
        public void Next()
        {
            Frapid.Config.Entities.EmailQueue emailQueue = Fixture().GetNext(0);
            Assert.NotNull(emailQueue);
        }
        ...
        public void Last()
        {
            Frapid.Config.Entities.EmailQueue emailQueue = Fixture().GetLast();
            Assert.NotNull(emailQueue);
        }
        ...
        {
            IEnumerable<Frapid.Config.Entities.EmailQueue> emailQueues = Fixture().Get(new long[] { });
