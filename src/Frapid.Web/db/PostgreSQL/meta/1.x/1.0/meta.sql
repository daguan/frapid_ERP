-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/00.db core/extensions.sql --<--<--
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/00.db core/postgresql-roles.sql --<--<--
DO
$$
BEGIN
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/01.types-domains-tables-and-constraints/tables-and-constraints.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/05.views/0.resource_view.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/05.views/localized_resource_view.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/06.functions-and-logic/add_localized_resource.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/06.functions-and-logic/add_resource.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/06.functions-and-logic/get_localization_table.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/06.functions-and-logic/get_output_for.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/06.functions-and-logic/get_resource.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/10.Localization/0.neutral-resource(en)/language.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/meta/1.x/1.0/src/99.ownership.sql --<--<--
DO
$$
    DECLARE this record;
BEGIN
