...
namespace Frapid.WebApi.DataAccess
{
    ...
    {
        public FormRepository(string schemaName, string tableName, string catalog, long loginId, int userId)
        {
        ...
        public dynamic Get(object primaryKey)
        {
            ...
            return Factory.Get<dynamic>(this.Catalog, sql, primaryKey).FirstOrDefault();
        }
        ...
        public dynamic GetFirst()
        {
            ...
            return Factory.Get<dynamic>(this.Catalog, sql).FirstOrDefault();
        }
        ...
        public IEnumerable<dynamic> Get(object[] primaryKeys)
        {
            ...
            return Factory.Get<dynamic>(this.Catalog, sql, new {primaryKeys});
        }
        ...
        public object Add(dynamic item)
        {
            ...
            return Factory.Insert(this.Catalog, item, this.FullyQualifiedObjectName, this.PrimaryKey);
        }
        ...
        public List<object> BulkImport(List<ExpandoObject> items)
        {
            if (!this.SkipValidation)
            {
                if (!this.Validated)
                {
                    this.Validate(AccessTypeEnum.ImportData, this.LoginId, this.Catalog, false);
                }
        ...
        public void Update(dynamic item, object primaryKey)
        {
            ...
            if (!this.SkipValidation)
            {
                if (!this.Validated)
                {
                    this.Validate(AccessTypeEnum.Edit, this.LoginId, this.Catalog, false);
                }
                if (!this.HasAccess)
                {
                    Log.Information(
            ...
            Factory.Update(this.Catalog, item, primaryKey, this.FullyQualifiedObjectName, this.PrimaryKey);
        }
        ...
        public void Delete(object primaryKey)
        {
            ...
            Factory.NonQuery(this.Catalog, sql, primaryKey);
        }
        ...
        {
            return EntityView.Get(this.Catalog, this.PrimaryKey, this._ObjectNamespace, this.GetTableName());
        }
    }
}